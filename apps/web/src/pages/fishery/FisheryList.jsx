    ...
    <>
      ...
      <div className="fishery-page">
        ...
        {loading ? (
          ...
          <p className="fishery-empty">No plantations yet. Add your first one!</p>
        ) : (
            ...
            {plantations.map(p => (
              <div key={p.id} className="fishery-card" onClick={() => navigate(`/fishery/${p.id}`)}>
                ...
                <div className="fishery-row-div">
                  {
                    !isEditing ? (
                      <div className="fishery-card-area">{p.area_ha} Ha</div>
                    ) : <></>
                  }
                  {
                    isEditing ? (
      ...
      {showDeleteModal && (
        <div className="fishery-modal-overlay" onClick={cancelDelete}>
          <div className="fishery-modal" onClick={e => e.stopPropagation()}>
            ...
            <p className="fishery-modal-text">Are you sure you want to delete this plantation? This action cannot be undone.</p>
